...
struct Badge: Identifiable {
    ...
    static let all: [Badge] = [
        ...
        Badge(title: "Exercice refait", systemImage: "arrow.counterclockwise.circle.fill", isUnlocked: false),
        Badge(title: "Amis fidèles", systemImage: "person.2.fill", isUnlocked: false),
